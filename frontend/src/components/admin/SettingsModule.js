  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-surface rounded-lg shadow p-6">
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-text-secondary mb-1">Header</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-text-secondary mb-1">Paragraph</label>
            <textarea
          ...
          <div>
            <label className="block text-sm font-medium text-text-secondary mb-1">Map Embed URL</label>
            <input
              type="text"
